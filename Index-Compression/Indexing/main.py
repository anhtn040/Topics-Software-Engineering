...
from function import PorterStemmer
...
def get_unsorted_index(index_unsorted, word_list, doc_id_counter, doclen):
    ...
    # print('index_unsorted',index_unsorted,'\n\nmax_tf',max_tf)    
    return index_unsorted, max_tf
...
query_list = [ "output", "power", "spatial", "process"]
